...
### 1byte = 8bit  = 0000 0000 = FF
### 32bit, 4byte, int32, 메모리 주소의 크기
|2진수|16진수|표현 개수|표현 범위|bit|
|---:|:---|:---|:---|:---|
|1111|F|16개|0 ~ 15|4bit|
|1111 1111|FF|256개|0 ~ 255|8bit, **1byte**|
|2 4 8 16 32 64 128 256|FF|256개|0 ~ 255|8bit, **1byte**|
|1111 1111 1111 1111|FFFF|65,536개|0 ~ 65,535|16bit, **2byte**|
|1111 1111 1111 1111 1111 1111 1111 1111|FFFF FFFF|4,294,967,296개|0 ~ 4,294,967,295|32bit, **4byte**|
